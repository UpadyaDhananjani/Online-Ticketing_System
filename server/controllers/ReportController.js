...
export const getTicketTypeDistribution = async (req, res) => {
  try {
    ...
    const typeCounts = {};
    tickets.forEach(ticket => {
      typeCounts[ticket.category] = (typeCounts[ticket.category] || 0) + 1;
    });
...
// Team Performance (example, adjust as needed)
// Duplicate getAssigneePerformance removed to fix redeclaration error.
>>>>>>> Stashed changes
