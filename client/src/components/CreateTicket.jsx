...
function CreateTicket() {
  ...
  return (
    <Container
      className="d-flex justify-content-center align-items-center min-vh-100 bg-gradient-to-br from-blue-50 to-blue-100 animate-fade-in"
      style={{ minHeight: '100vh' }}
    >
      <Row className="w-100 justify-content-center">
        <Col xs={12}>
          <Card className="shadow-lg border-0 animate-pop" style={{ borderRadius: 20,  width: '100%', background: 'white', animation: 'popIn 0.6s cubic-bezier(.68,-0.55,.27,1.55)' }}>
